...
def get_cifar10(root, n_labeled, n_unlabled,
    ...
    try:
        ...
        targets = base_dataset.train_labels

    train_labeled_idxs, train_unlabeled_idxs, val_idxs = train_val_split(targets, int(n_labeled), int(n_unlabled))
    ...
    train_unlabeled_dataset = CIFAR10_unlabeled(root, train_unlabeled_idxs, train=True,
                                                transform=TransformTwice(
                                                    transform_train))  # transform=TransformTwice(transform_train))
...
def train_val_split(labels, n_labeled_per_class, n_unlabled_per_class):
    ...
    for i in range(10):
        ...
        train_unlabeled_idxs.extend(idxs[n_labeled_per_class:n_labeled_per_class + n_unlabled_per_class])
